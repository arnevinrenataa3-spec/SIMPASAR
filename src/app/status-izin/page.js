      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <header className="pt-4 lg:sticky lg:top-12">
            ...
            <div className="mt-8 flex gap-6 border-t border-slate-800 pt-6 text-xs text-slate-500"><span>Tanpa NIK</span><span>Tanpa nomor HP</span><span>Data aman</span></div>
          </header>
          <PublicPermitLookup />
        </div>
      </div>
