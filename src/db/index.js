/**
 * @description Inisialisasi koneksi PostgreSQL dengan Drizzle ORM query builder.
...
// Schema diberikan ke Drizzle agar query builder memakai referensi tabel yang sama.
